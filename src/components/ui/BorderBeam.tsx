 ...
 *
 * MagicUI Interactive Primitive: BorderBeam
 * An animated glowing light beam that travels seamlessly around card borders.
 */
  ...
  return (
    <div
      ...
      className={`pointer-events-none absolute inset-0 rounded-[inherit] [border:calc(var(--border-width))_solid_transparent] 
        ...
        after:[offset-anchor:calc(var(--anchor))_50%] 
        after:[offset-path:rect(0_auto_auto_0_round_calc(var(--size)))] ${className}`}
    />
  );
};
