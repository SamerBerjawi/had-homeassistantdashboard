          ...
          >
            ...
            <div className="p-5 border-b border-slate-200/60 dark:border-slate-800/80 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-2xl bg-[#7B61FF]/15 text-[#7B61FF] dark:text-[#9D8BFF] border border-[#7B61FF]/30 flex items-center justify-center shadow-xs">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-[#7B61FF]/15 text-[#7B61FF] dark:text-[#9D8BFF] font-bold">
                      {ALL_PHOSPHOR_ICONS.length}+
                    </span>
                  </div>
                  <p className="text-xs text-slate-400 font-medium">
                    Customize icon for <span className="font-bold text-[#7B61FF] dark:text-[#9D8BFF]">{targetName}</span>
                  </p>
                </div>
              </div>
                ...
                return (
                  <motion.button
                    ...
                    className={`p-3 rounded-2xl border flex flex-col items-center justify-center gap-1.5 text-center transition-all cursor-pointer relative group ${
                      isSelected
                        ? 'bg-[#7B61FF]/15 border-[#7B61FF] text-[#7B61FF] dark:text-[#9D8BFF] ring-2 ring-[#7B61FF]/30 shadow-md'
                        : darkMode
                  ...
                  >
                    ...
                    {isSelected && (
                      <div className="absolute top-1.5 right-1.5 w-3.5 h-3.5 rounded-full bg-[#7B61FF] text-white flex items-center justify-center shadow-xs">
            ...
            <div className="p-4 border-t border-slate-200/60 dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-900/40 flex items-center justify-between shrink-0">
              ...
              <button
                type="button"
                onClick={onClose}
                className="px-5 py-2 rounded-xl bg-[#7B61FF] hover:bg-[#684be3] text-white text-xs font-bold shadow-md shadow-[#7B61FF]/30 cursor-pointer transition-colors"
              >
                Done
              </button>
            </div>
