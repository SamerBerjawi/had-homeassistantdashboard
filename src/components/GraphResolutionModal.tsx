        ...
        >
          ...
          <div className="p-6 border-b border-white/10 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <ShareNetwork size={32} weight="duotone" className="text-sky-400 shrink-0" />
              <div>
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={onClose}
                className="w-9 h-9 rounded-xl bg-white/5 hover:bg-white/15 border border-white/10 text-slate-300 hover:text-white flex items-center justify-center transition-colors cursor-pointer"
              >
          ...
          {metrics && (
            <div className={`px-6 py-3 border-b flex flex-wrap items-center gap-4 text-xs font-semibold ${
              ...
              <div className="flex items-center gap-1.5">
                <Package size={16} weight="duotone" className="text-indigo-400" />
          ...
          <div className="px-6 pt-4 flex items-center gap-2 border-b border-slate-200/50 dark:border-slate-800/80">
            {[
              ...
              { id: 'connection', label: 'HA WebSocket Endpoint', icon: WifiHigh }
            ].map(tab => {
              const Icon = tab.icon;
