...
export default function EnergyUsageGraphCard({
  ...
  return (
    ...
    >
      ...
      {/* Stacked Bar Chart with Zero Baseline */}
      <div className="relative w-full h-64 sm:h-72 pt-2 pb-6 flex flex-col justify-between">
        {buckets.length === 0 ? (
          ...
          <div className="w-full h-full flex flex-col relative">
            ...
            <div
              className="w-full flex items-end justify-between gap-1 sm:gap-1.5"
            ...
            >
              {buckets.map((bucket, idx) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="w-full max-w-[24px] rounded-t-md overflow-hidden flex flex-col-reverse transition-all duration-300 group-hover:brightness-125"
            ...
            <div className={`w-full h-px ${darkMode ? 'bg-white/20' : 'bg-slate-300'}`} />

            {/* Lower Negative Section (Grid Export & Battery Charging) */}
            <div
              className="w-full flex items-start justify-between gap-1 sm:gap-1.5"
            ...
            >
              {buckets.map((bucket, idx) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="w-full max-w-[24px] rounded-b-md overflow-hidden flex flex-col transition-all duration-300 group-hover:brightness-125"
                      style={{ height: `${heightPct}%` }}
                    >
                      {exportPart > 0 && (
                        <div
