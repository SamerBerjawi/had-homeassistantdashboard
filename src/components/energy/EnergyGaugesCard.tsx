...
export default function EnergyGaugesCard({
  ...
  return (
    <div
      className={`w-full h-full rounded-3xl p-5 sm:p-6 backdrop-blur-2xl transition-all duration-300 relative overflow-hidden isolate flex flex-col justify-between ${
