...
export default function EnergyGaugesCard({
  ...
  return (
    <div
      className={`w-full h-full rounded-3xl p-5 sm:p-6 backdrop-blur-sm transition-all duration-300 relative overflow-hidden isolate shadow-[4px_6px_12px_rgba(0,0,0,0.15)] flex flex-col justify-between ${
