      ...
      <AnimatePresence>
        {actionFeedback && (
          <motion.div
            ...
            className="fixed top-20 right-6 z-50 px-4 py-2.5 rounded-2xl bg-slate-950/90 text-white border border-amber-500/40 backdrop-blur-xl shadow-2xl flex items-center gap-2.5 text-xs font-bold"
          >
